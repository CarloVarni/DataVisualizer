...
int main() {
  ...
  RootFileHistogramMakerConfiguration.extractionFunction =
					 ...
					 std::shared_ptr<EventDataModel::HistogramObjectCollection_2D>>
    {
     ...
     // 2D
     histo_collection_2d->emplace_back("muon_reco_pT_vs_eta",
				       "muon_reco_pT",
				       "muon_reco_eta",
				       * (TH2F*) file->Get("muon_reco_pT_vs_eta")->Clone("muon_reco_pT_vs_eta"));
     histo_collection_2d->emplace_back("muon_reco_pT_vs_phi",
                                       "muon_reco_pT",
				       "muon_reco_phi",
                                       * (TH2F*) file->Get("muon_reco_pT_vs_phi")->Clone("muon_reco_pT_vs_phi"));
     histo_collection_2d->emplace_back("muon_reco_eta_vs_phi",
                                       "muon_reco_eta",
				       "muon_reco_phi",
                                       * (TH2F*) file->Get("muon_reco_eta_vs_phi")->Clone("muon_reco_eta_vs_phi"));

     histo_collection_2d->emplace_back("muon_truth_pT_vs_eta",
				       "muon_truth_pT",
				       "muon_truth_eta",
				       * (TH2F*) file->Get("muon_truth_pT_vs_eta")->Clone("muon_truth_pT_vs_eta"));
     histo_collection_2d->emplace_back("muon_truth_pT_vs_phi",
                                       "muon_truth_pT",
				       "muon_truth_phi",
                                       * (TH2F*) file->Get("muon_truth_pT_vs_phi")->Clone("muon_truth_pT_vs_phi"));
     histo_collection_2d->emplace_back("muon_truth_eta_vs_phi",
                                       "muon_truth_eta",
				       "muon_truth_phi",
                                       * (TH2F*) file->Get("muon_truth_eta_vs_phi")->Clone("muon_truth_eta_vs_phi"));
