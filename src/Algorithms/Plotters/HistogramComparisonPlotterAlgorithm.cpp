...
HistogramComparisonPlotterAlgorithm::HistogramComparisonPlotterAlgorithm(
...
void HistogramComparisonPlotterAlgorithm::DrawCollection(
    TCanvas &canvas, EventDataModel::HistogramObjectCollection_1D &collection) {
  canvas.cd();
