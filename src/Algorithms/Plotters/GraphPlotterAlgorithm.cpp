...
GraphPlotterAlgorithm::GraphPlotterAlgorithm(const std::string &name,
					     const Algorithm::PlotterAlgorithm<EventDataModel::GraphObjectCollection>::Config &cfg)
  : PlotterAlgorithm(name, cfg) {}
  
void
GraphPlotterAlgorithm::DrawCollection(const EventDataModel::GraphObjectCollection *collection) {
