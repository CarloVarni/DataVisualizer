...
EfficiencyComparisonPlotterAlgorithm::EfficiencyComparisonPlotterAlgorithm(
...
void EfficiencyComparisonPlotterAlgorithm::DrawCollection(
    TCanvas &canvas, EventDataModel::EfficiencyObjectCollection &collection) {
  canvas.cd();
