...
Efficiency1DPlotterAlgorithm::Efficiency1DPlotterAlgorithm(const std::string &name,
							   const Algorithm::PlotterAlgorithm<EventDataModel::EfficiencyObjectCollection>::Config &cfg)
  : PlotterAlgorithm(name, cfg) {}
  
void
Efficiency1DPlotterAlgorithm::DrawCollection(const EventDataModel::EfficiencyObjectCollection *collection) {
