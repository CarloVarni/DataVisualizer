...
namespace Algorithm {
  ...
  class MultiDataGraphMakerAlgorithm
  ...
  public:
    ...
    MultiDataGraphMakerAlgorithm(const std::string& name,
				 const Config& cfg);
    MultiDataGraphMakerAlgorithm(const MultiDataGraphMakerAlgorithm&) = delete;
    MultiDataGraphMakerAlgorithm& operator=(const MultiDataGraphMakerAlgorithm&) = delete;
