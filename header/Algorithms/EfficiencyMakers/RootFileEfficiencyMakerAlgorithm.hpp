...
namespace Algorithm {
  ...
  class RootFileEfficiencyMakerAlgorithm
  ...
  public:
    ...
    RootFileEfficiencyMakerAlgorithm(const std::string& name,
				     const Config& cfg);
    RootFileEfficiencyMakerAlgorithm(const RootFileEfficiencyMakerAlgorithm&) = delete;
    RootFileEfficiencyMakerAlgorithm& operator=(const RootFileEfficiencyMakerAlgorithm&) = delete;
