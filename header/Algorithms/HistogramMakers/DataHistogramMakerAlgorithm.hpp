...
namespace Algorithm {
  ...
  class DataHistogramMakerAlgorithm
  ...
  public:
    ...
    DataHistogramMakerAlgorithm(const std::string& name,
				     const Config& cfg);
    DataHistogramMakerAlgorithm(const DataHistogramMakerAlgorithm&) = delete;
    DataHistogramMakerAlgorithm& operator=(const DataHistogramMakerAlgorithm&) = delete;
