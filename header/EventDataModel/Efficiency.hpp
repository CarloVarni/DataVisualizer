...
public:
  Efficiency() = delete;
  Efficiency(const std::string &title, TEfficiency efficiency);
  Efficiency(const std::string &title, const std::string &target_variable_x,
             TEfficiency efficiency);
  Efficiency(const std::string &title, const std::string &target_variable_x,
             const std::string &target_variable_y, TEfficiency efficiency);
  ~Efficiency() = default;

  void Fill(const DataObject &data, bool isGood);
  void Fill(const MultiDataObject &data, bool isGood);
